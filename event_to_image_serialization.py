...
class ImageSerializer():
    ...
    def read_events_write_images(self, in_path, out_path ):
        ...
        print('read {} events'.format(dijet_features.shape[0]))
        # mass cut
        mjj_idx = labels.index('mJJ')
        mjj_arr = dijet_features[:,mjj_idx]
        events_j1, events_j2, dijet_features = ut.filter_arrays_on_value( events_j1, events_j2, dijet_features, filter_arr=mjj_arr, filter_val=self.mjj_cut )
        # convert to images
...
if __name__ == "__main__":
    ...
    serializer.read_events_write_images( args.infile, args.outfile )
